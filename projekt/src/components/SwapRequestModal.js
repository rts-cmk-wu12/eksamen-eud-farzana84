            ...
            <div className="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
                <div className="p-6">
                    ...
                    <div className="mb-6 p-4 bg-gray-50 rounded-lg">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-600">by {targetListing.swapperName}</p>
                            </div>
                        </div>
                    </div>
                    {isOwnItem && (
                        ...
                        <div className="mb-6">
                            ...
                            {loading ? (
                                ...
                                <div className="text-center py-8 text-gray-600">
                                    ...
                                    <p className="text-sm mt-1">List an item first to propose swaps!</p>
                                </div>
                            ) : (
                    ...
                    <div className="flex gap-3">
                        ...
                        >
                            {submitting ? "Sending..." : isOwnItem ? "Cannot Swap Own Item" : "Send Swap Request"}
                        </button>
                    </div>
                </div>
            </div>
